...
// Obtener una instancia de Firestore después de inicializar la aplicación de Firebase
...
//
// Crear un documento con ID específica
...
console.log (docSnapAlumno.exists()) 
...
let mail_agendados
let tema_agendado 
let duracion_agendada
let mensaje_agendado

async function consultarAgenda (mesyanio)
{
  for (let chj =0; chj <= 30; chj++) 
  {
    for (let chk=0; chk <= 23; chk++ )
    {
      arrayvacia1 [chj] [chk] = 0
      arrayvacia2 [chj] [chk] = ""
      arrayvacia3 [chj] [chk] = ""
      arrayvacia4 [chj] [chk] = "0"
      arrayvacia5 [chj] [chk] = ""
    }
  }

  disponibilidad = arrayvacia1
  mail_agendados = arrayvacia2
  tema_agendado = arrayvacia3
  duracion_agendada = arrayvacia4
  mensaje_agendado = arrayvacia5
  ...
  { 
    ...
    if (isNaN.disponumerica) {disponumerica=0}
